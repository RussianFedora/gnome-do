...
# https://bugs.launchpad.net/do/+bug/647495
Patch0:			gnome-do-no-disable-deprecated.patch
...
%changelog
* Thu Oct  6 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 0.8.3.1-2.2
- rebuilt against gcc bug
- fix https://bugs.launchpad.net/do/+bug/647495

* Thu Feb 25 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 0.8.3.1-2.1
- build with zoom
